...
class DownstreamTrainer(pl.Callback):
    def __init__(self, data_dir="/workspace/repos/TCGA/data/", downstream_max_epochs=5, downstream_lr=1e-5, downstream_group_sz=4) -> None:
        ...
        self.train_ds = DownstreamTrainingDataset(root_dir=data_dir, transform=train_transforms, dataset_type="train", group_size=self.training_group_size, subset_size=0.5)
        self.val_ds = DownstreamTrainingDataset(root_dir=data_dir, transform=val_transforms, dataset_type="test", group_size=self.training_group_size, subset_size=0.5)
    ...
    def on_validation_epoch_end(self, trainer, pl_module):
        ...
        if trainer.current_epoch == trainer.max_epochs:
            print("BAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD")
